...
void TimerFive::setPwmDuty(char pin, int duty) // expects duty cycle to be 12 bit 4096 (50%=2048, 100%=4096)
{
...
void TimerFive::pwm(char pin, int duty, long microseconds)  // expects duty cycle to be 12 bit 4096 (50%=2048, 100%=4096)
{
