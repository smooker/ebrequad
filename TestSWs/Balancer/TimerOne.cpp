 ...
 *  Modified March 2010 by Albert Sanz to make compatible with Arduino Mega Timer1
 *
...
void TimerOne::setPwmDuty(char pin, int duty) // expects duty cycle to be 10 bit (4096)  (50%=2048, 100%=4096)
{
...
void TimerOne::pwm(char pin, int duty, long microseconds)  // expects duty cycle to be 10 bit (4096)  (50%=2048, 100%=4096)
{
